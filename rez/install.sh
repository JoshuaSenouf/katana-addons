...
echo -e "[INSTALL][ARGS] KATANA-ADDONS VERSION: ${KATANA_ADDONS_VERSION}"
...
# We install katana-addons.
echo -e "\n"
echo -e "[INSTALL] Installing katana-addons-${KATANA_ADDONS_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[INSTALL] Finished installing katana-addons-${KATANA_ADDONS_VERSION}!"
echo -e "\n"
